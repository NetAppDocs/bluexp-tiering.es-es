...
. En la página Configuración avanzada, arrastre el almacén de objetos que desee utilizar a la ubicación del almacén de objetos de réplica.
+
...
. En la página Advanced Settings (Configuración avanzada), haga clic en el icono de menú del agregado y seleccione *Unmirror Object Store*.
+
