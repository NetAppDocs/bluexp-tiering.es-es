...
https://bluexp.netapp.com/cloud-tiering-service-tco["Utiliza la calculadora de TCO de Cloud Tiering para ver cuánto dinero puedes ahorrar"^].
...
Para obtener más información sobre el valor que ofrece Cloud Tiering, https://bluexp.netapp.com/cloud-tiering["Visite la página de Cloud Tiering en el sitio web de BlueXP"^].


TIP: Los sistemas Cloud Volumes ONTAP son de solo lectura de la organización en niveles del cloud. https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-tiering.html["Configuras la organización en niveles para los sistemas Cloud Volumes ONTAP desde el entorno de trabajo en BlueXP"^].
