...
Después de comprar una licencia de organización en niveles de BlueXP, necesitarás utilizar la cartera digital de BlueXP para añadir la licencia. link:task-licensing-cloud-tiering.html#use-a-bluexp-tiering-byol-license["Descubre cómo utilizar una licencia BYOL para la organización en niveles de BlueXP"].
