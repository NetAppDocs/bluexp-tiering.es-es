...
Licencia:: No es necesaria una licencia de organización en niveles de BlueXP en tu cuenta de BlueXP ni una licencia de FabricPool en el clúster de ONTAP para organizar los datos en niveles en StorageGRID.
