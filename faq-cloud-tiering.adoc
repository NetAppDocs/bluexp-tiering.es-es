...
Aparte de la organización en niveles de BlueXP, https://docs.netapp.com/us-en/active-iq-unified-manager/["Active IQ Unified Manager"^] y.. https://docs.netapp.com/us-en/active-iq/index.html["Asesor digital de Active IQ"^] se puede utilizar para la supervisión y la creación de informes.
