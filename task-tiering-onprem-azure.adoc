...
+
** Una conexión HTTPS a través del puerto 443 al servicio Cloud Tiering y al almacenamiento de objetos de Azure Blob (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["consulte la lista de extremos"^])
